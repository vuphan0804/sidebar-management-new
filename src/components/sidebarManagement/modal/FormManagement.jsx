...
const FormManagement = ({
  ...
  console.log("updateNodeSidebar", updateNodeSidebar);
  //   useEffect(() => {
  ...
  const { title, idNode, parentId, count, iconInput } = formValue;
  ...
  const updateHandler = () => {
    if (updateNodeSidebar) {
      updateNode(updateNodeSidebar, formValue);
    }
  };
  useEffect(() => {
    if (!isOpenForm) {
                  ...
                  <div className="text-center mt-6">
                    ...
                    {selectedIcon ? (
                      <button
                        ...
                        type="button"
                      >
                        <img className="w-8 h-8 mx-auto" src={iconURL} alt="" />
                      </button>
                    ) : null}
                  </div>
                </form>
